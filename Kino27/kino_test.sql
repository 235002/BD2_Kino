...
--
-- Host: 127.0.0.1
-- Czas generowania: 19 Sty 2019, 20:56
...
(35, 'TEST1', 'TEST1', 'TEST1', 'TEST1', '2000-01-01', 'TEST1', 100),
(42, 'ZielonaMila', 'FrankDabrot', 'FrankDabro', 'Komedia', '1999-01-24', 'USA', 178),
(43, 'Avengers', 'Tom Hiller', 'Jack Oneal', 'przygodowy', '2018-08-09', 'USA', 190),
...
--
ALTER TABLE `osoba`
  MODIFY `ID_osoba` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=305;

--
-- AUTO_INCREMENT dla tabeli `repertuar`
--
ALTER TABLE `repertuar`
  MODIFY `ID_repertuar` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
...
--
ALTER TABLE `sala`
  MODIFY `ID_sala` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12302;
